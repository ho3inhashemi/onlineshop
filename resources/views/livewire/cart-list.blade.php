...
<div>
    ...
    <div class="flex-1">
          ...
          <tbody>
            ...
            <tr>
              <td class="hidden pb-4 md:table-cell">
                <a href="#">
                  <img src="{{ $item['attributes']['img'] }}" class="w-20 rounded" alt="Thumbnail">
                </a>
              </td>
              <td>
                <a href="#">
        ...
        <div class="mt-5">
            ...
            <a href="{{ route('cart.order') }}" class="px-6 mx-4 py-2 text-red-800 bg-yellow-300"> Order These Products</a>
        </div>
